...
> ❌ **Form failure diagnosis:** Got '0123456789', expected '٠١٢٣٤٥٦٧٨٩'. Inspect the strategy module output.
...
| **normalised_form** | `CAIRO` | `None` | ❌ FAIL |

> ❌ **Method failure diagnosis:** The strategy for field_type='city' language='ar' returned None or raised NotImplementedError. Check that the strategy module is fully implemented and wired into the router.
...
> ❌ **Method failure diagnosis:** The strategy for field_type='city' language='ja' returned None or raised NotImplementedError. Check that the strategy module is fully implemented and wired into the router.
...
|---|---|---|---|
| **method** | `GEOGRAPHIC` | `UNRESOLVED` | ❌ FAIL |
| **normalised_form** | `BEIJING` | `None` | ❌ FAIL |

> ❌ **Method failure diagnosis:** The strategy for field_type='city' language='zh' returned None or raised NotImplementedError. Check that the strategy module is fully implemented and wired into the router.
...
|---|---|---|---|
| **method** | `GEOGRAPHIC` | `UNRESOLVED` | ❌ FAIL |
| **normalised_form** | `SEOUL` | `None` | ❌ FAIL |

> ❌ **Method failure diagnosis:** The strategy for field_type='city' language='ko' returned None or raised NotImplementedError. Check that the strategy module is fully implemented and wired into the router.
...
| **normalised_form** | `ALEXANDER NICKNAMED SASHA` | `None` | ❌ FAIL |

> ❌ **Method failure diagnosis:** The strategy for field_type='alias' language='ru' returned None or raised NotImplementedError. Check that the strategy module is fully implemented and wired into the router.
...
|---|---|---|---|
| **method** | `NMT` | `UNRESOLVED` | ❌ FAIL |
| **normalised_form** | `KNOWN AS NIKOS` | `None` | ❌ FAIL |

> ❌ **Method failure diagnosis:** The strategy for field_type='alias' language='el' returned None or raised NotImplementedError. Check that the strategy module is fully implemented and wired into the router.
...
|---|---|---|---|
| **method** | `NMT` | `UNRESOLVED` | ❌ FAIL |
| **normalised_form** | `PIERRE-HENRI LEFEVRE KNOWN AS LE VIEUX` | `None` | ❌ FAIL |

> ❌ **Method failure diagnosis:** The strategy for field_type='alias' language='fr' returned None or raised NotImplementedError. Check that the strategy module is fully implemented and wired into the router.
...
|---|---|---|---|
| **method** | `NMT` | `UNRESOLVED` | ❌ FAIL |
| **normalised_form** | `MARIO DE LUCA KNOWN AS IL PROFESSORE` | `None` | ❌ FAIL |

> ❌ **Method failure diagnosis:** The strategy for field_type='alias' language='it' returned None or raised NotImplementedError. Check that the strategy module is fully implemented and wired into the router.
