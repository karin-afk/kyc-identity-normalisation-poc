...
> ❌ **Method failure diagnosis:** GPT-4o-mini classified as 'free_text' instead of 'person_name'. The router received the wrong field type and could not find a matching strategy.
